...
public strictfp class RobotPlayer {
    ...
    static void runEnlightenmentCenter() throws GameActionException {
        ...
        if(rc.isReady()) {
            if(rc.getEmpowerFactor(rc.getTeam(), 11) > 4){
    ...
    static void runPolitician() throws GameActionException {
        ...
        if(rc.getInfluence() > 50) {
            ...
            if(rc.getInfluence()*rc.getEmpowerFactor(rc.getTeam(), 0)-10 > rc.getInfluence()){
                if (ecloc.isWithinDistanceSquared(rc.getLocation(), 1) && rc.canEmpower(1)) {
                    rc.empower(1);
                    return;
                }
                tryMove(rc.getLocation().directionTo(ecloc));
                return;
            }
